...
path_images_from_camera = r"val_recognize/face_dlib/data/data_faces_from_camera"

# Dlib 正向人脸检测器 / Use frontal face detector of Dlib
detector = dlib.get_frontal_face_detector()

# Dlib 人脸 landmark 特征点检测器 / Get face landmarks
predictor = dlib.shape_predictor(r'val_recognize/face_dlib/data/data_dlib/shape_predictor_5_face_landmarks.dat')

# Dlib Resnet 人脸识别模型，提取 128D 的特征矢量 / Use Dlib resnet50 model to get 128D face descriptor
face_reco_model = dlib.face_recognition_model_v1(r'val_recognize\face_dlib\data\data_dlib\dlib_face_recognition_resnet_model_v1.dat')
...
def main_tranfer():
    ...
    person_list = os.listdir(r"val_recognize/face_dlib/data/data_faces_from_camera/")
    person_list.sort()

    with open(r"val_recognize/face_dlib/data/features_all.csv", "w", newline="") as csvfile:
        ...
        for person in person_list:
            ...
            features_mean_personX = np.insert(features_mean_personX, 0, person_name.split('_')[-1], axis=0)
