...
predictor = dlib.shape_predictor('val_recognize/face_dlib/data/data_dlib/shape_predictor_5_face_landmarks.dat')

# Dlib Resnet 人脸识别模型，提取 128D 的特征矢量 / Use Dlib resnet50 model to get 128D face descriptor
face_reco_model = dlib.face_recognition_model_v1("val_recognize/face_dlib/data/data_dlib/dlib_face_recognition_resnet_model_v1.dat")
...
class Face_Recognizer:
    ...
    def get_face_database(self):
        if os.path.exists("val_recognize/face_dlib/data/features_all.csv"):
            path_features_known_csv = "val_recognize/face_dlib/data/features_all.csv"
    ...
    def process(self, frame):
        ...
        return img_with_name,is_get_face,self.current_frame_face_name_list
    def recoginition(self,frame):
